...
const reemplazo = document.querySelector("#content-area")

console.log(reemplazo)

const originalP = reemplazo.querySelector("p")
console.log(originalP)

const cloneP = originalP.cloneNode(true)//si no se pone true solamente clona la etiqueta con sus estilos
console.log(cloneP)

const miElemento = document.querySelector("#miElemento")
console.log(miElemento)
miElemento.append(cloneP)
cloneP.textContent = "Nuevo texto del clon"

const mainMenu = document.querySelector("#contentArea")
console.log(mainMenu)
//mainMenu.lastChild.replaceWith(originalP)
mainMenu.children[2].replaceWith(originalP)